...
public class UIUtils {
    ...
    public static AlertDialog makeSimpleAlertDialogWithNegativeButton(String title, String message, String positiveText, final Context context, DialogInterface.OnClickListener positiveClickListener, String negativeText) {
        ...
        builder.setNegativeButton(negativeText, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (context != null) {
                    UIUtils.hideDialog(context, dialog);
                }
            }
        });
    ...
    public static void showToastMessage(String text) {
        ...
        toast = Toast.makeText(AppApplication.getInstance(), text, Toast.LENGTH_SHORT);
        toast.show();
    }
}
